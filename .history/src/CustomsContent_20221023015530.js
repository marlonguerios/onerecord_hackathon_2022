...
class CustomsContent extends Component {
    ...
    shouldInclude(awb) {
        return awb["iata:customsInfo:customsClearanceStatus"] == "NEW"
            || (awb["iata:customsInfo:customsClearanceStatus"] == "RFI" &&
                awb["iata:customsInfo:customsInfoNote"] == "")
    }

    countByStage(stage) {
        return this.state.bookings.filter((awb) => awb[""] == stage).length;
    }

    render() {
        return <div id="customs-content">
            <div className="customs-content-stats">
                <div className="customs-content-stats-card customs-content-stats-card--newbooking">5<br />New Booking</div>
                <div className="customs-content-stats-card customs-content-stats-card--received">5<br />Received at Warehouse</div>
                <div className="customs-content-stats-card customs-content-stats-card--screened">5<br />Screened</div>
