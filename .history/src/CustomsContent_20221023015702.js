    ...
    render() {
        return <div id="customs-content">
            <div className="customs-content-stats">
                <div className="customs-content-stats-card customs-content-stats-card--newbooking">{this.countByStage("New Booking")}<br />New Booking</div>
                <div className="customs-content-stats-card customs-content-stats-card--received">{this.countByStage("Received")}<br />Received at Warehouse</div>
