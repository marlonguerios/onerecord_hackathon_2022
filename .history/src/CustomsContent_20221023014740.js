    ...
    render() {
        return <div id="customs-content">
            <div className="customs-content-stats">
                <div className="customs-content-stats-card">5<br />New Booking</div>
                <div className="customs-content-stats-card">5<br />Received at Warehouse</div>
                <div className="customs-content-stats-card">5<br />Screened</div>
                <div className="customs-content-stats-card">
                    5<br />
                    Sealed
                </div>
