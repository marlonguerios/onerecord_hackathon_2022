                ...
                {this.state.bookings.map((awb) => {
                    ...
                    className="customs-awb-card">
                        ...
                        <div className="customs-awb-card-reason">
                            ...
                            <button onClick={this.setStatusWithReason}  id={"card-reason-button-" + awb["iata:booking:waybillNumber"]["iata:waybill:waybillNumber"]}>Send</button>
                        </div>
                    </div>
                })}
            </div>
