...
class CustomsContent extends Component {
    ...
    setFilterByStage(e) {
        ...
        console.log(stage)
        if (this.state.filterByStage == stage) {
            this.setState({
                filterByStage: null
            });
        } else {
    ...
    render() {
        return <div id="customs-content">
            <div className="customs-content-stats">
                ...
                <div className="customs-content-stats-card customs-content-stats-card--screened" onClick={this.setFilterByStage} data-stage="Screened">{this.countByStage("Screened")}<br />Screened</div>
                <div className="customs-content-stats-card customs-content-stats-card--sealed"  onClick={this.setFilterByStage} data-stage="Info Provided">
                {this.countByStage("Info Provided")}<br />
                Info Provided
                </div>
                <div className="customs-content-stats-card customs-content-stats-card--readytoload"  onClick={this.setFilterByStage} data-stage="Ready to load">
