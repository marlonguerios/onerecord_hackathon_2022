    ...
    render() {
        return <div id="customs-content">
            <div className="customs-content-stats">
                <div className="customs-content-stats-card">New Booking</div>
                <div className="customs-content-stats-card">Received at Warehouse</div>
                <div className="customs-content-stats-card">Screened</div>
                <div className="customs-content-stats-card">Sealed</div>
                <div className="customs-content-stats-card customs-content-stats-card--readytoload">Ready to Load</div>
            </div>
