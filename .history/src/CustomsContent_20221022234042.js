            ...
            <div className="customs-content-table">
                {this.state.bookings.filter((awb) => this.shouldInclude(awb) )
                    ...
                    className="customs-awb-card">
                        ...
                        <div className="customs-awb-card-description">{awb["iata:booking:shipmentDetails"]["iata:piece:goodsDescription"]}</div>
                        <div className="customs-awb-card-shipper">{awb["iata:booking:shipper"]["iata:company:companyName"]}</div>
