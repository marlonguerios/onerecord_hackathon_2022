                    ...
                    renderCell: (record) => {
                        return (
                            <>
                                ...
                                <Modal open={this.state.openModal} onClose={this.handleClose} BackdropProps={{ style: { opacity: 0.5 } }}>
                                    <Box sx={{width: 800 }}>
                                        <div style={{ display: "flex", flexDirection: "row", justifyContent: 'space-between' }}>
                                            <div style={{ marginLeft: '15.7rem' }}> <h2 >AirwayBill Details</h2></div>
                                            <div style={{ marginBottom: '4rem', marginRight: '-2.3rem' }}>  <CloseIcon className="close-icon" onClick={this.handleClose} ></CloseIcon></div>
                                        </div>
                                        ...
                                        <div style={{ display: "flex", flexDirection: "column", justifyContent: 'space-between' }}>
                                            ...
                                            <div style={{ display: "flex", flexDirection: "row", justifyContent: 'center' }}>
                                                <div>
                                                    <Button variant="contained" onClick={this.updateBooking} endIcon={<SendIcon />}>
                                                        Request Status
                                                    </Button>
                                                </div>
