            ...
            gridColumns: [
                ...
                { field: "col4", headerName: "O & D", width: 135 },
                {
                    ...
                    renderCell: (record) => {
                        return (
                            <>
                            <select onChange={this.updateBooking} data-awb={record.row.id}>
                                <option></option>
                                <option selected value="Received" { ...record.row.stage == "Received" ? "selected" : ""} >Received</option>
                                <option value="Screened" { ...record.row.stage == "Screened" ? "selected" : ""} >Screened</option>
                                <option value="Sealed" { ...record.row.stage == "Sealed" ? "selected" : ""}>Sealed</option>
                                <option value="Ready to load" { ...record.row.stage == "Ready to load" ? "selected" : ""}>Ready</option>
                            </select>
                            </>
                        )
                    }
        ...
        this.setState({
            ...
            gridRows: bookings.map((record) => {
                ...
                return {
                    ...
                    customsNote: tp["iata:customsInfo:customsInfoNote"],
                    stage: tp["iata:bookingOption:shipmentSecurityStatus"]
                }
            })
        })
    }
